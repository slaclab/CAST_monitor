...
visa_address = 'TCPIP::172.21.161.49::INSTR' # for TDS scope
#visa_address = 'TCPIP::172.21.161.39::INSTR' # for MDO scope
...
while run == 1:
    ...
    time.sleep(5) # update rate in seconds for TDS scope
    #time.sleep(0.1) # update rate to 10 Hz for MDO scope
